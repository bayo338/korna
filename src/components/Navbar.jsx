  ...
  return (
    <>
      <div className="block sm:hidden bg-white text-xs text-center py-2 border-b w-full overflow-x-hidden">
        <a href="#" className="inline-flex items-center justify-center text-gray-600 hover:underline gap-1">Open in app <ExternalLink size={14} className="inline-block text-gray-500" /></a>
      </div>
